...
urlpatterns = [
    ...
    path('_api/page/<uuid:group_id>/move-section/', views.page_move_section, name='page_move_section'),
    path('_api/page/<uuid:group_id>/tags/', views.page_tags_update, name='page_tags_update'),
